...
<div id="mySidenav" class="sidenav">
  ...
  <a href="handler/addLecturer.php">Add Lecturer</a>
  <!-- <a href="handler/addStudent.php">Add Student</a> -->
  <a href="handler/addItem.php">Add Item</a>
  <a href="handler/viewItem.php">View</a>
...
<div id="apDiv2"><br><img src="images/Regent-Banner6.jpg" width="500" height="200">
</div>

<form class="formoid-flat-yellow" style="background-color:#ffffff;font-size:14px;font-family:'Lato', sans-serif;color:#666666;max-width:100%;min-width:150px" method="post" action="handler/addStudent.php">
 ...
 <center><h2><p class="bg-primary">Adding Students Details.</p></h2></center>
  ...
  <div class="element-number"><label class="title">Student Level<span class="required">*</span></label><input class="small" type="number"  name="level" required value=""/></div><br>

  <div class="submit"><input name="addStudent" type="submit" value="Submit"/></div></form>
	</div>
