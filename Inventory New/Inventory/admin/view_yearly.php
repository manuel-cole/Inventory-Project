...
$sql="SELECT * FROM livestock WHERE YEAR(arrival_date) = '$reportYear' ";
...
<tbody>       
    ...
    $result = mysqli_query($con,"SELECT * FROM item WHERE YEAR(arrival_date) = '$reportYear' ");
...
echo "<h3><center>Records of Items in inventory on $reportYear </center></h3><br><br>";
