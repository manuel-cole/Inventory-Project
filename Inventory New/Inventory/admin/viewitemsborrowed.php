 ...
 <div class="row">
    ...
    <thead style="background: #FFD700; color: White;">
		...
		<tr>
			...
			<th style="color: #3b3b3b;">Item Name / Description</th>
			<th style="color: #3b3b3b;">Item ID</th>
			<th style="color: #3b3b3b;">Student ID</th>
...
<tbody>       
    <?php
    $result = mysqli_query($con, "SELECT * FROM item WHERE status = ''") or die(mysqli_error($con));
    $count = mysqli_num_rows($result);
echo "<b><center><h3>Items borrowed by Lecturer or Student</h3></center></b><br><br>";
...
while($row=mysqli_fetch_array($result)){
    ...
    <tr>
			...
			<td><input type="" name="studentid[]" value="<?php echo $row['studentid'];?>" readonly></label></td>
			<td><input type="" name="requestdate[]" value="<?php echo $row['requestdate'];?>" readonly></label></td>
			<td><input type="" name="returndate[]" value="<?php echo $row['returndate'];?>" readonly></label></td>
