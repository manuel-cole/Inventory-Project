...
while($row=mysqli_fetch_array($result)){
    ...
    <tr>
			  <td><center><input type="checkbox" name="check[<?php echo $row['id']; ?>]" value="1" ></center></td>
                                              <td><input type="" name="status[]" value="<?php echo $row['itemid'];?>" readonly></td>
                                              <td><input type="" name="name[]" value="<?php echo $row['name'];?>" readonly></td>
                                              <td><input type="" name="brand_name[]" value="<?php echo $row['manufacturer'];?>" readonly></td>
                                              ...
                                              <td><a href="status.php?itemid=<?php echo $row['itemid'];?>" class="btn btn-success"> Update Item</td>
    </tr>
